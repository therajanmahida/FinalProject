        ...
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <div class="user-details">
                    ...
                    <div class="user-info">
                        <div>
                            <a href="#setting-dropdown" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Rajan<span class="mdi mdi-menu-down"></span></a>
                        </div>
                    </div>
                </div>
                ...
                <ul>
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-invert-colors"></i> <span>Croods User Interface </span> <span class="menu-arrow"></span></a>
                        <ul class="list-unstyled">
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-layers"></i><span> Supplier </span> <span class="menu-arrow"></span></a>
                        <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="calendar.html" class="waves-effect"><i class="mdi mdi-calendar"></i><span> Staff </span></a>
                    </li>
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-heart-outline"></i><span> Finance </span> <span class="menu-arrow"></span></a>
                        <ul class="list-unstyled">
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Inventory </span> <span class="menu-arrow"></span></a>
                        <ul class="list-unstyled">
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-chart-arc"></i><span> Calender </span> <span class="menu-arrow"></span></a>
                        <ul class="list-unstyled">
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-google-pages"></i><span> Invoices </span> <span class="menu-arrow"></span></a>
                        <ul class="list-unstyled">
...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var _message_tab = $('#dashboard_tab');
